...
rat_waste_filtered$location <- gsub("\\(|\\)", "", rat_waste_filtered$location) # Remove parentheses
coordinates <- strsplit(rat_waste_filtered$location, ", ")
sf_data <- st_as_sf(data.frame(
