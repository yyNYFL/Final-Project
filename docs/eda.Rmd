...
### Table 1. Rat sightings by zip codes
```{r}
...
**Table 1.** The zip codes with the most 311 rat sightings are in the above kable and are associated in order with the areas of the Upper West Side, Bedford- Stuyvesant, Prospect Heights, Bushwick, Flatbush, and Ridgewood. It is interesting that Brooklyn had more zip codes in top six zipcodes of rat sightings but a Manhattan zipcode had the most rat sightings.

### Table 2. Rat sightings by month each year 
...
**Table 2.**The month with the most rat sightings varied each year so you cannot necesarily see the seasonality of the data just by analyzing the data but when ploting the data by borough, the seasonality is much more apparent.
